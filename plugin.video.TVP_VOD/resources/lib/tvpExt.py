...
class tvpExt:
    ...
    def sportTrans(self):#TVP SPORT
        ...
        for t in transDataRev:
            ...
            setArt={'thumb': t[2], 'poster': t[2], 'banner': t[2], 'icon': t[2], 'fanart': fanart}
    ...
    def itemCategs(self,aid):
        ...
        for i in resp['items']:
            img=''
            setArt={'thumb': '', 'poster': img_path+'rc.png', 'banner': '', 'icon': 'OverlayUnwatched.png', 'fanart': fanart}
    ...
    def regionyList(self):
        ...
        setArt={'thumb': '', 'poster': img_path+'tvp3.png', 'banner': '', 'icon': 'OverlayUnwatched.png', 'fanart': fanart}
    ...
    def progCategs(self,aid):
        ...
        setArt={'thumb': '', 'poster': img_path+'tvp3.png', 'banner': '', 'icon': 'DefaultGenre.png', 'fanart': fanart}
        ...
        for i in resp['items']:
            ...
            setArt={'thumb': '', 'poster': img, 'banner': '', 'icon': 'DefaultGenre.png', 'fanart': fanart}
            url_cont = base.build_url({'mode':'progList','asset_id':str(i['asset_id'])})
            base.addItemList(url_cont, i['title'], setArt)
    ...
    def epList(self,aid,pg):
        ...
        if start+int(cnt)<resp['total_count']:        
            ...
            base.addItemList(url_cont, '[B][COLOR=cyan]>>> Następna strona[/COLOR][/B]', setArt,'video')
    ...
    def videoList(self,portal,cid,page): #TVP INFO
        ...
        if int(page)*limit+len(resp['data']['items'])<total:
            setArt={'thumb': '', 'poster': '', 'banner': '', 'icon': img_path+'empty.png', 'fanart': fanart}
