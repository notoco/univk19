...
def logIn():
    kod=xbmcgui.Dialog().input(u'Wpisz kod ze strony [B]https://vod.tvp.pl/logowanie-tv[/B]:', type=xbmcgui.INPUT_ALPHANUM)#from: vod.tvp.pl/logowanie-tv
    if kod:
